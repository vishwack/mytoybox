...
You can also create an entity with a labelled value. Here's an example of how to do that.
...
LUModeller tool *does not* support the following LUIS entity types:
- Regular expression
- Hierarchical
- Composite
